...
const WhatsAppCommunity: React.FC = () => {
    const t = useTranslations('whatsappCommunity');
    const [isPressed, setIsPressed] = useState(false);

    return (
        <section id="community" className="py-10 lg:py-16">
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#25D366] to-[#128C7E] p-8 md:p-12">
                ...
                <div className="relative z-10 flex flex-col items-center text-center text-white">
                    ...
                    <a
                        href={siteDetails.whatsappGroupUrl}
                        target="_blank"
                        ...
                        className="inline-flex items-center justify-center font-semibold rounded-2xl border-2 px-8 py-4 text-lg bg-white text-[#128C7E] border-gray-200 cursor-pointer transition-transform duration-75 select-none"
                        style={{
                            boxShadow: isPressed ? 'none' : '0 6px 0 0 #d1d5db',
